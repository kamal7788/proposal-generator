...
const navigation = [
  ...
  { name: "Sections", href: "/sections", icon: "M4 6h16M4 10h16M4 14h16M4 18h16" },
  { name: "Case Studies", href: "/case-studies", icon: "M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" },
...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-brand-green text-white flex flex-col z-40">
      <div className="px-6 py-5 border-b border-white/10">
        <Link href="/dashboard" className="flex items-center gap-3">
          <div className="w-8 h-8 bg-brand-cream rounded-lg flex items-center justify-center">
            <span className="text-brand-green font-bold text-sm">BA</span>
          </div>
          <div>
            <h1 className="text-lg font-bold tracking-tight">BrandAid</h1>
            <p className="text-xs text-white/60">Proposal Generator</p>
          </div>
        </Link>
      </div>
